...
/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetContentTypeArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetDescriptionArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetFileNameArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetHeightArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetSizeArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetTitleArgs = {
  locale?: InputMaybe<Scalars['String']>;
};


/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetUrlArgs = {
  locale?: InputMaybe<Scalars['String']>;
...
/** Represents a binary file in a space. An asset can be any file type. */
export type Cf_AssetWidthArgs = {
  locale?: InputMaybe<Scalars['String']>;
};

export type Ct_Asset = {
  __typename?: 'CT_Asset';
  custom?: Maybe<CustomFieldsType>;
  description?: Maybe<Scalars['String']>;
  descriptionAllLocales?: Maybe<Array<LocalizedString>>;
...
export type Ct_AssetDescriptionArgs = {
  acceptLanguage?: InputMaybe<Array<Scalars['Locale']>>;
  locale?: InputMaybe<Scalars['Locale']>;
};


export type Ct_AssetNameArgs = {
  acceptLanguage?: InputMaybe<Array<Scalars['Locale']>>;
  locale?: InputMaybe<Scalars['Locale']>;
};
...
export type Channel = ReviewTarget & Versioned & {
  __typename?: 'Channel';
...
/** [See type definition](https://app.contentful.com/spaces/lnt6uzpd7mux/content_types/product) */
export type Product = Entry & ReviewTarget & Versioned & {
  __typename?: 'Product';
  contentfulMetadata: ContentfulMetadata;
  createdAt: Scalars['DateTime'];
  createdBy?: Maybe<Initiator>;
  hest?: Maybe<Scalars['String']>;
  id: Scalars['String'];
  key?: Maybe<Scalars['String']>;
  lastModifiedAt: Scalars['DateTime'];
  lastModifiedBy?: Maybe<Initiator>;
...
export type ProductFilter = {
  ...
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  hest?: InputMaybe<Scalars['String']>;
  hest_contains?: InputMaybe<Scalars['String']>;
  hest_exists?: InputMaybe<Scalars['Boolean']>;
  hest_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  hest_not?: InputMaybe<Scalars['String']>;
  hest_not_contains?: InputMaybe<Scalars['String']>;
  hest_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  sys?: InputMaybe<SysFilter>;
...
export type QueryCf_ProductArgs = {
  id: Scalars['String'];
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
};
...
export type QueryCt_ProductArgs = {
  id?: InputMaybe<Scalars['String']>;
  key?: InputMaybe<Scalars['String']>;
  sku?: InputMaybe<Scalars['String']>;
  variantKey?: InputMaybe<Scalars['String']>;
...
export type ExampleQueryQuery = { __typename?: 'Query', CF_product?: { __typename?: 'Product', hest?: string | null, test?: string | null } | null, products: { __typename?: 'ProductQueryResult', results: Array<{ __typename?: 'Product', id: string }> } };


export const ExampleQueryDocument = gql`
    query exampleQuery($id: String!, $sku: String, $variantKey: String, $key: String, $where: String, $sort: [String!], $limit: Int, $offset: Int, $skus: [String!]) {
  CF_product(id: $id) {
    hest
    test
  }
